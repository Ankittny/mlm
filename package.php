              ...
              <div class="pricing__item-inner">
                <div class="pricing__item-content">
                  ...
                  <div class="pricing__item-top">
                    <h6 class="mb-15">BRONZE</h6>
                    <h3 class="mb-25">₹ 3K/<span>Monthly</span> </h3>
                  </div>

                  <!-- pricing middle part -->
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span>Bluetooth Speaker</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Smart Watch </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Ear bud</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Electric Kettle  </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Hair Dryer </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Bag </li>
                    </ul>
              ...
              <div class="pricing__item-inner">
                <div class="pricing__item-content">
                  ...
                  <div class="pricing__item-top">
                    ...
                    <h3 class="mb-25">₹ 6K/<span>Monthly</span> </h3>
                  </div>

                  <!-- pricing middle part -->
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"  class="dark"></span> Home Theater </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Ear bud  </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Smart Watch</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Hair Dryer </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Electric Kettle  </li>
              ...
              <div class="pricing__item-inner">
                <div class="pricing__item-content">
                  ...
                  <div class="pricing__item-top">
                    ...
                    <h3 class="mb-25">₹ 9K/<span>Monthly</span> </h3>
                  </div>

                  <!-- pricing middle part -->
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                    <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"  class="dark"></span>RO Water Purifier </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Home Theater </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Smart Watch</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Ear buds </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Hair Dryer  </li>
              ...
              <div class="pricing__item-inner">
                <div class="pricing__item-content">
                  ...
                  <div class="pricing__item-top">
                    ...
                    <h3 class="mb-25">₹ 11K/<span>Monthly</span> </h3>
                  </div>

                  <!-- pricing middle part -->
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                    <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"  class="dark"></span>32” Android Smart LED </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Smart Watch  </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Ear buds</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> BT Speaker </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span>Electric Kettle  </li>
            ...
            <div class="pricing__item" data-aos="fade-left" data-aos-duration="1000">
              <div class="pricing__item-inner">
                <div class="pricing__item-content">
                  ...
                  <!-- pricing top part -->
                  <div class="pricing__item-top">
                    <h6 class="mb-15">DIAMOND </h6>
                    <h3 class="mb-25">₹ 17K/<span>Monthly</span> </h3>
                  </div>

                  <!-- pricing middle part -->
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                    <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"  class="dark"></span>43” Android Smart 4K LED </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Smart Watch  </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Sound Bar</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Ear buds </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span>Electric Kettle  </li>
            ...
            <div class="pricing__item" data-aos="fade-left" data-aos-duration="1000">
              <div class="pricing__item-inner">
                <div class="pricing__item-content">
                  ...
                  <!-- pricing top part -->
                  <div class="pricing__item-top">
                    <h6 class="mb-15">Emerald </h6>
                    <h3 class="mb-25">₹ 30K/<span>Monthly</span> </h3>
                  </div>

                  <!-- pricing middle part -->
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                    <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"  class="dark"></span>50” Android Smart 4K LED </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Home theater  </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Smart Watch</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span> Ear buds </li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check" class="dark"></span>Hair Dryer</li>
